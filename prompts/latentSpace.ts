export const getLatentSpaceExplorerPrompt = (numIdeas: number = 4): string => `
...
For the given image, please identify ${numIdeas} interesting visual patterns or "free associations". For each one, provide:
